...
@Component({
    templateUrl: './grivancereport.html',
    styleUrls: ['./grivancereport.css']
})

export class GrivanceReportComponent {
    ...
    displayedColumns: string[] = ['nGrievanceId','tGrievanceType', 'tGrievanceStatus', 'tGrievanceSubject','tGrievanceDescription','tFileUploadPath', 'dCreatedDt', 'EditAction', 'DeleteAction'];
